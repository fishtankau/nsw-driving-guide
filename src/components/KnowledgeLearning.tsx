    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      >
        ...
        <p className="text-slate-500 mt-3 max-w-2xl mx-auto">
          Study the complete NSW Road Users Handbook below.
        </p>
      </motion.div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-3 bg-slate-50 border-b border-slate-200">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400">212 pages</span>
            </div>
            <a
              href="/road-user-handbook.pdf"
              target="_blank"
          ...
          <iframe
            ref={iframeRef}
            src="/road-user-handbook.pdf"
            title="NSW Road Users Handbook"
      ...
      <div className="text-center mt-10 mb-6">
        <p className="text-xs text-slate-400">
          Information based on the NSW Road Users Handbook and Transport for NSW guidelines.
